...
document.addEventListener("DOMContentLoaded", () => {
    ...
    switch(moodInput.value) {
        case 'Very Happy': 
            toggleClass(myMood, 'very-happy-mood', ['happy-mood', 'not-so-happy-mood'])
            break;
        case 'Happy':
            toggleClass(myMood, 'happy-mood', ['very-happy-mood', 'not-so-happy-mood'])
            break;
        case 'Not So Happy':
            toggleClass(myMood, 'not-so-happy-mood', ['very-happy-mood', 'happy-mood'])
            break;
        default:
            break;
    }
